[![Gopher Holds The Rules](https://github.com/farisekananda/grule-rule-engine/blob/master/gopher-grule.png?raw=true)](https://github.com/farisekananda/grule-rule-engine/blob/master/gopher-grule.png?raw=true)
